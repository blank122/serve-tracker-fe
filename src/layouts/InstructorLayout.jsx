...
const InstructorLayout = ({ children, user }) => {
  ...
  const navigation = [
    ...
    { name: 'ML Predictions', path: '/instructor/predict', roles: ['Admin', 'Instructor'], icon: 'chart' },
    { name: 'Student Records', path: '/registrar/students', roles: ['Admin', 'Registrar'], icon: 'users' },
    { name: 'User Management', path: '/admin/users', roles: ['Admin'], icon: 'shield' },
  ];
